...
def plot_1d_iteration(model, X_grid, train_X, new_X, f, acq_func):
    """
    ...
    Args:
        ...
        train_X: Observed data up to this iteration (n, 1)
        new_X: Next point to query (1, 1) or None if final iteration
    ...
    with torch.no_grad():
        ...
        ax.plot(X_grid, f(X_grid), c="k", ls="--", label="Objective function")
...
def plot_1d_interactive(bo_loop: BOLoop):
    ...
    def step(iteration):
        ...
        # Plot
        plot_1d_iteration(model, X_grid, train_X, new_X, oracle, acq_func)
